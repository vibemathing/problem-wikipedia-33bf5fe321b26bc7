...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-33bf5fe321b26bc7"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-33bf5fe321b26bc7",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-33bf5fe321b26bc7",
        "url": "https://en.wikipedia.org/wiki/Snake-in-the-box"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The snake-in-the-box problem: what is the longest possible induced path in an $n$ -dimensional hypercube graph?",
      "version": 1
    },
    "title": "snake-in-the-box",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "c907b1faa5749c00dc2e92ae72f836bbe900af61da3f10e0391f7a0fa2c4d5c0"
}
```
